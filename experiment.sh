...
PYTHONUNBUFFERED=1 nohup python finetune_regression.py --dataset esol --gpu 5 > logs/finetune_esol_$runname.log 2>&1 &
PYTHONUNBUFFERED=1 nohup python finetune_regression.py --dataset freesolv --gpu 6 --bs 31 > logs/finetune_freesolv_$runname.log 2>&1 &
PYTHONUNBUFFERED=1 nohup python finetune_regression.py --dataset lipo --gpu 7 > logs/finetune_lipo_$runname.log 2>&1 &