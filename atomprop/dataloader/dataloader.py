...
class SDFToInputs:
    ...
    """
    @staticmethod
    def convert(sdf_path: str, context_length: int = 420):
        """
        Convert an SDF file to atom type indices and edges.
        :param sdf_path: The path to the SDF file.
        :param context_length: The maximum number of atoms in a molecule for padding.
        :return: A list of tuples, each containing the atom embeddings and edge (adj matrix, value is bond type index, -1 for no edge), and the RDKit molecule object.
        """
