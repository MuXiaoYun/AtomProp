...
- **GeATNet**: Stacks multiple GeAT layers with residual connections and layer normalization for robust feature learning. Applies global multi-head self-attention within each graph to aggregate atomic-level representations into graph-level embeddings
